...
| Inspiration | `.inspiration-section`, `.group-cards`, `.place-card` | Show the six highest-scoring recommendations returned for the saved profile using the same card template as search results. |
